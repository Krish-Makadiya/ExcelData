            ...
            <div className="w-full max-w-6xl bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="mb-6 flex flex-row items-center gap-4 justify-between">
                    <div className="flex gap-2 items-center">
                        <label className="text-lg font-semibold text-gray-700">Upload Excel file:</label>
                        <input
                            type="file"
                            accept=".xlsx, .xls"
                ...
                {fileLoaded ? (
                    ...
                    <div className="text-center text-gray-500 text-lg mt-12">Please upload an Excel file to get started.</div>
                )}
            </div>
        </div>
    );
